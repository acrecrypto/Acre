...
#   c) node1 mines 32 blocks, so now node 0 has 500000ACRE, node 1 has 4250ACRE, node2 has none.
#   d) node0 sends 601 ACRE to node2, in two transactions (301 ACRE, then 300 ACRE).
