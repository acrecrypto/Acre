...
```bash
    ...
    From https://github.com/acre/acre
...
For example:
```bash
URL=https://github.com/konez2k/acre.git
...
[acre/gitian.sigs](https://github.com/acre/gitian.sigs/) repository, or if that's not possible to create a pull
request.
